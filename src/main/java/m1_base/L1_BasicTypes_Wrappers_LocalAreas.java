...
public class L1_BasicTypes_Wrappers_LocalAreas {
    ...
    public static void wrappers() {
        ...
        // Также в таких классах есть некоторые полезные методы и константы, например минимальное значение типа int можно узнать использовав
        // константу Integer.MIN_VALUE.
        ...
        // Рекомендуется использовать valueOf, он может быть быстрее и использовать меньше памяти потому что применяет кэширование,
        // а конструктор всегда создает новый объект.
